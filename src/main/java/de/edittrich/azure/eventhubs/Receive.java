...
public class Receive
{
    public static void main(String args[]) throws InterruptedException, ExecutionException
    {
    	...
    	String namespaceName = "edittrich-data-ns";
    	String eventHubName = "edittrich-data-ns-ev";
    	String sasKeyName = "RootManageSharedAccessKey";
    	String sasKey = "<Key>";
    	String storageConnectionString = "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=edittrichdatastac;AccountKey=<Key>";
    	String storageContainerName = "messages";
    	String hostNamePrefix = "edittrichdatastac";
